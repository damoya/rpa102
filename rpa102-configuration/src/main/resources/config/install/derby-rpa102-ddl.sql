...
DROP TABLE TEACHERS_BY_ACADEMIC_YEAR;
...
CREATE TABLE TEACHERS_BY_ACADEMIC_YEAR
(
	TEACHER_ID VARCHAR(15) NOT NULL,
	ACADEMIC_YEAR_ID VARCHAR(10) NOT NULL,

	CONSTRAINT TEACHERS_BY_ACADEMIC_YEAR_PK PRIMARY KEY (TEACHER_ID, ACADEMIC_YEAR_ID),
	CONSTRAINT TEACHERS_BY_ACADEMIC_YEAR_FK1 FOREIGN KEY (ACADEMIC_YEAR_ID) REFERENCES ACADEMIC_YEARS (ID),
	CONSTRAINT TEACHERS_BY_ACADEMIC_YEAR_FK2 FOREIGN KEY (TEACHER_ID) REFERENCES TEACHERS (ID)
);
...
(
	...
	INTERRUPT_TEACHER_EXPLANATION_CAUSE BOOLEAN,
	TO_NOT_WORK_CAUSE BOOLEAN,
	SMOKE_CAUSE BOOLEAN,
	HIT_OTHER_STUDENT_CAUSE BOOLEAN,
	OTHER_CAUSE BOOLEAN,
...
INSERT INTO CONFIG (PARAM_ID, VALUE, PARAM_NAME) VALUES ('CurrentAcademicYear', '2017-2018', 'Año Académico por defecto');
